...
class map_iterator
{
	...
	public:
		...
		map_iterator() : ptr_(NULL), root_(NULL), TNILL_(NULL) {}

		map_iterator(node_pointer ptr, node_pointer root, node_pointer TNILL) : ptr_(ptr), root_(root), TNILL_(TNILL) {}

		map_iterator(const map_iterator &other) // : ptr_(other.ptr_), root_(other.root_), TNILL_(other.TNILL_) {}
		{
