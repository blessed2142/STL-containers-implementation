#ifndef CONST_REVERSE_MAP_ITERATOR
#define CONST_REVERSE_MAP_ITERATOR
...
class const_reverse_map_iterator
{
	...
	public:
		...
		const_reverse_map_iterator() : ptr_(NULL), root_(NULL), TNILL_(NULL) {}

		const_reverse_map_iterator(node_pointer ptr, node_pointer root, node_pointer TNILL) : ptr_(ptr), root_(root), TNILL_(TNILL) {}
		// map_iterator(node_pointer ptr) : ptr_(ptr) {}

		template <typename U> 
		const_reverse_map_iterator(const reverse_map_iterator<Key, T, U> &other) : ptr_(other.ptr_), root_(other.root_), TNILL_(other.TNILL_) {}

		const_reverse_map_iterator(const const_reverse_map_iterator &other) // : ptr_(other.ptr_), root_(other.root_), TNILL_(other.TNILL_) {}
		{
	...
	// 	map_iterator(node_pointer ptr) : ptr_(ptr) {}
	// 	map_iterator(const map_iterator &other) : ptr_(other.ptr_) {}
	// 	~map_iterator() {}
	...
	// 	}
		...
		bool operator==(const const_reverse_map_iterator &other)
		{
